			  ...
			  const struct argconfig_commandline_options *options)
{
	...
	printf("\033[1mUsage: %s\033[0m\n\n",
	       append_usage_str);
	fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 99, \"func\": \"argconfig_print_help\", \"file_name\": \"argconfig.c\", \"msg\": \"\033[1mUsage: %s\033[0m\"}\n", append_usage_str);
	...
	fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 100, \"func\": \"argconfig_print_help\", \"file_name\": \"argconfig.c\", \"msg\": \"\033[1mOptions:\033[0m\"}\n");
		...
		if (s->config_type == CFG_STRING) {
			...
			*((size_t *) value_addr) = strtol(optarg, &endptr, 0);
			if (errno || optarg == endptr) {
				...
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 91, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected integer argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
			...
			*((int *)value_addr) = strtol(optarg, &endptr, 0);
			if (errno || optarg == endptr) {
				fprintf(stderr,
					"Expected integer argument for '%s' but got '%s'!\n",
					long_opts[option_index].name, optarg);
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 92, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected integer argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
			...
			if (errno || tmp < 0 || tmp > 1 || optarg == endptr) {
				fprintf(stderr,
					...
					long_opts[option_index].name, optarg);
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 93, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected 0 or 1 argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
			*((int *)value_addr) = tmp;
			...
			if (errno || tmp >= (1 << 8)  || optarg == endptr) {
				fprintf(stderr,
					...
					long_opts[option_index].name, optarg);
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 94, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected byte argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
			*((uint8_t *) value_addr) = tmp;
			...
			if (errno || tmp >= (1 << 16) || optarg == endptr) {
				fprintf(stderr,
					...
					long_opts[option_index].name, optarg);
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 95, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected short argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
			*((uint16_t *) value_addr) = tmp;
			...
			if (errno || optarg == endptr) {
				fprintf(stderr,
					...
					long_opts[option_index].name, optarg);
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 96, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected word argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
			...
			*((unsigned long *)value_addr) = strtoul(optarg, &endptr, 0);
			if (errno || optarg == endptr) {
				fprintf(stderr,
					...
					long_opts[option_index].name, optarg);
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 97, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected long integer argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
			...
			*((double *)value_addr) = strtod(optarg, &endptr);
			if (errno || optarg == endptr) {
				fprintf(stderr,
					...
					long_opts[option_index].name, optarg);
				fprintf(fptr, "{\"type\": \"instrumentation\", \"id\": 98, \"func\": \"argconfig_parse\", \"file_name\": \"argconfig.c\", \"msg\": \"Expected float argument for '%s' but got '%s'!\"}\n", long_opts[option_index].name, optarg);
				goto out;
			}
